...
import javafx.scene.text.FontWeight; import javafx.scene.layout.StackPane; import javafx.scene.shape.Polygon;
public class JavaFXstop extends Application { 
	@Override
...
primaryStage.setTitle("JavaFXstop"); 
